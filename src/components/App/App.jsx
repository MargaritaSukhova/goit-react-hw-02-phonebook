...
class App extends Component {
  ...
  checkContacts = (name) => {
    ...
    return this.state.contacts.find(contact => contact.name.toLocaleLowerCase() === normalizedName)
  }
  ...
  render() {
    ...
    return (
      <Container>
        ...
        <Filter value={this.state.filter} onChangeFilter={this.handleFilerChange} />
        <ContactList contacts={visibleContacs} onContactDelete={this.handleContactDelete} />
      </Container>
    );
  }
}
